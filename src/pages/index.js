...
export default function ResumePage() {
  return (
    <Layout>
      ...
      <article className="resume-page single-container">
        {/* Header Header Info */}
        ...
        <section className="resume-section">
          ...
          <div className="resume-job">
            <div className="resume-job-header">
              <h3 className="company-name"><a href="https://balto.ai" target="_blank" rel="noreferrer">Balto AI</a></h3>
          ...
          <div className="resume-job">
            <div className="resume-job-header">
              <h3 className="company-name">Yum! Brands</h3>
              <span className="job-date">March 2020 – April 2021</span>
            </div>
          ...
          <div className="resume-job">
            <div className="resume-job-header">
              <h3 className="company-name">DAIS Technology</h3>
              <span className="job-date">August 2018 – March 2020</span>
            </div>
            <div className="job-title">Lead Front End Software Engineer</div>
            <ul className="resume-list">
          ...
          <div className="resume-job">
            <div className="resume-job-header">
              ...
              <span className="job-date">January 2018 – August 2018</span>
            </div>
          ...
          <div className="resume-job">
            <div className="resume-job-header">
              <h3 className="company-name">Lettuce Entertain You Enterprises</h3>
        ...
        <section className="resume-section">
          ...
          <div className="resume-job">
            <div className="resume-job-header">
              <h3 className="company-name">Robert Morris University</h3>
              <span className="job-date">2007 – 2011</span>
            </div>
            <div className="job-title">Bachelor of Professional Studies, Culinary Arts</div>
          </div>
        </section>
      </article>
    </Layout>
